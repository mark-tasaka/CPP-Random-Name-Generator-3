...
vector<string> MaleName::africanGivenNamesMale(int count) const
{
...
vector<string> MaleName::africanAmericanGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::americanGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::arabicGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::armenianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::celticGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::chineseGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::czechGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::danishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::dutchGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::egyptianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::englishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::finnishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::frenchGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::gaelicGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::germanGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::greekGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::hawaiianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::hebrewGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::hindiGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::hungarianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::indianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::irishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::italianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::japaneseGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::koreanGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::latinGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::middleEnglishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::nativeAmericanGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::norseGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::oldEnglishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::oldFrenchGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::oldGermanGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::oldNorseGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::persianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::polishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::polynesianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::russianGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::sanskritGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::scandinavianGivenNamesMale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Amund", "Arvid", "Bjorn", "Canute", "Carolus", "Carson", "Dag", "Davin", "Denholm", "Dyre", "Egil", "Elvis", "Eric", "Filip", "Fortinbras", "Frey", "Haakon", "Hannes", "Igor", "Ingmar", "Ingvar", "Jarl", "Kaj", "Karr", "Kelsey", "Kerr", "Kettil", "Knute", "Kolby", "Lars", "Ludvig", "Lunt", "Mats", "Nels", "Niels", "Norb", "Odell", "Odo", "Olan", "Pal", "Quinby", "Rad", "Rune", "Skjøld", "Snorre", "Steinar", "Stieran", "Sven", "Sølve", "Thiassi", "Thoralf", "Thorin", "Thorstein", "Toste", "Tryggvi", "Ulffr", "Ulick", "Ull", "Ulrik", "Ulster", "Ultar", "Vali", "Vannevar", "Vanslow", "Vidar", "Vidkun", "Viggo", "Viljalmr", "Viljo", "Von", "Waage", "Wray", "Zvi"
    };
...
vector<string> MaleName::scottishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::slavicGivenNamesMale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Casimir", "Duscha", "Evzen", "Gavril", "Ilie", "Jan", "Kostya", "Ludovic", "Marót", "Melik", "Mete", "Miroslav", "Mladen", "Oleg", "Ondrea", "Pavel", "Pavlos", "Pavo", "Peja", "Polixenes", "Polk", "Radman", "Reza", "Vaclav", "Vas", "Vencel", "Vlade", "Vladimir", "Volya", "Wenceslaus", "Wieslav", "Ziven", "Zorro", "Zorya", "Zydrunas"
    };
...
vector<string> MaleName::spanishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::swahiliGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::swedishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::teutonicGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::turkishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::vietnameseGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::welshGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::yiddishGivenNamesMale(int count) const
{
    vector<string> randomNames;
...
vector<string> MaleName::getFirstName(int select, int count) const
{
    vector<string> firstName;

    if (select == 1)
    {
        firstName = africanGivenNamesMale(count);
    }
    else if (select == 2)
    {
        firstName = africanAmericanGivenNamesMale(count);
    }
    else if (select == 3)
    {
        firstName = americanGivenNamesMale(count);
    }
    else if (select == 4)
    {
        firstName = arabicGivenNamesMale(count);
    }
    else if (select == 5)
    {
        firstName = armenianGivenNamesMale(count);
    }
    else if (select == 6)
    {
        firstName = celticGivenNamesMale(count);
    }
    else if (select == 7)
    {
        firstName = chineseGivenNamesMale(count);
    }
    else if (select == 8)
    {
        firstName = czechGivenNamesMale(count);
    }
    else if (select == 9)
    {
        firstName = danishGivenNamesMale(count);
    }
    else if (select == 10)
    {
        firstName = dutchGivenNamesMale(count);
    }
    else if (select == 11)
    {
        firstName = egyptianGivenNamesMale(count);
    }
    else if (select == 12)
    {
        firstName = englishGivenNamesMale(count);
    }
    else if (select == 13)
    {
        firstName = finnishGivenNamesMale(count);
    }
    else if (select == 14)
    {
        firstName = frenchGivenNamesMale(count);
    }
    else if (select == 15)
    {
        firstName = gaelicGivenNamesMale(count);
    }
    else if (select == 16)
    {
        firstName = germanGivenNamesMale(count);
    }
    else if (select == 17)
    {
        firstName = greekGivenNamesMale(count);
    }
    else if (select == 18)
    {
        firstName = hawaiianGivenNamesMale(count);
    }
    else if (select == 19)
    {
        firstName = hebrewGivenNamesMale(count);
    }
    else if (select == 20)
    {
        firstName = hindiGivenNamesMale(count);
    }
    else if (select == 21)
    {
        firstName = hungarianGivenNamesMale(count);
    }
    else if (select == 22)
    {
        firstName = indianGivenNamesMale(count);
    }
    else if (select == 23)
    {
        firstName = irishGivenNamesMale(count);
    }
    else if (select == 24)
    {
        firstName = italianGivenNamesMale(count);
    }
    else if (select == 25)
    {
        firstName = japaneseGivenNamesMale(count);
    }
    else if (select == 26)
    {
        firstName = koreanGivenNamesMale(count);
    }
    else if (select == 27)
    {
        firstName = latinGivenNamesMale(count);
    }
    else if (select == 28)
    {
        firstName = middleEnglishGivenNamesMale(count);
    }
    else if (select == 29)
    {
        firstName = nativeAmericanGivenNamesMale(count);
    }
    else if (select == 30)
    {
        firstName = norseGivenNamesMale(count);
    }
    else if (select == 31)
    {
        firstName = oldEnglishGivenNamesMale(count);
    }
    else if (select == 32)
    {
        firstName = oldFrenchGivenNamesMale(count);
    }
    else if (select == 33)
    {
        firstName = oldGermanGivenNamesMale(count);
    }
    else if (select == 34)
    {
        firstName = oldNorseGivenNamesMale(count);
    }
    else if (select == 35)
    {
        firstName = persianGivenNamesMale(count);
    }
    else if (select == 36)
    {
        firstName = polishGivenNamesMale(count);
    }
    else if (select == 37)
    {
        firstName = polynesianGivenNamesMale(count);
    }
    else if (select == 38)
    {
        firstName = russianGivenNamesMale(count);
    }
    else if (select == 39)
    {
        firstName = sanskritGivenNamesMale(count);
    }
    else if (select == 40)
    {
        firstName = scandinavianGivenNamesMale(count);
    }
    else if (select == 41)
    {
        firstName = scottishGivenNamesMale(count);
    }
    else if (select == 42)
    {
        firstName = slavicGivenNamesMale(count);
    }
    else if (select == 43)
    {
        firstName = spanishGivenNamesMale(count);
    }
    else if (select == 44)
    {
        firstName = swahiliGivenNamesMale(count);
    }
    else if (select == 45)
    {
        firstName = swedishGivenNamesMale(count);
    }
    else if (select == 46)
    {
        firstName = teutonicGivenNamesMale(count);
    }
    else if (select == 47)
    {
        firstName = turkishGivenNamesMale(count);
    }
    else if (select == 48)
    {
        firstName = vietnameseGivenNamesMale(count);
    }
    else if (select == 49)
    {
        firstName = welshGivenNamesMale(count);
    }
    else if (select == 50)
    {
        firstName = yiddishGivenNamesMale(count);
    }
