...
vector<string> FemaleName::armenianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Erato", "Karyan", "Keran", "Lucine", "Ohanna", "Seda", "Siran", "Siroun", "Sirvat", "Taleen", "Taline", "Ziazan"
    };
...
vector<string> FemaleName::celticGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Fallon", "Flannery", "Kaie", "Kaitlyn", "Kassidy", "Kathleen", "Keena", "Keir", "Keira", "Keita", "Kendall", "Kenna", "Kera", "Kern", "Kiara", "Kirra", "Kylee", "Lachlan", "Lorna", "Maeve", "Malise", "Morgance", "Morgandy", "Nonnita", "Nuala", "Raelin", "Rhonda", "Saoirse", "Saraid", "Seanna", "Shela", "Shylah", "Tara", "Teranika", "Tieve", "Treasa", "Treva"
    };
...
vector<string> FemaleName::czechGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Bela", "Kalene", "Katarzyna", "Krista", "Krysta", "Marjeta", "Nadezda", "Pribislava", "Rickena", "Ryba", "Virsila", "Vondra", "Zdenek", "Zelenka", "Zuza"
    };
...
vector<string> FemaleName::danishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Dagmar", "Madja", "Saffi", "Semine"
    };
...
vector<string> FemaleName::dutchGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Brandie", "Haven", "Hester", "Kaatje", "Kalie", "Liannaka", "Lieneke", "Lonikie", "Nelleke", "Schuyler", "Tryne", "Van"
    };
...
vector<string> FemaleName::egyptianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Chione", "Femi", "Hekenu", "Hekt", "Icess", "Kanika", "Khety", "Lapis", "Mariasha", "Nakia", "Nashwa", "Nebta", "Neferu", "Neith", "Nile", "Nubia", "Ramla", "Rennefer", "Sabola", "Sagira", "Sahirah", "Salama", "Sanura", "Suma", "Tauret", "Tetisheri"
    };
...
vector<string> FemaleName::finnishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Kaija", "Kalle", "Louhi", "Preita", "Senja", "Tarja", "Terhi"
    };
...
vector<string> FemaleName::gaelicGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Blaine", "Blair", "Eilis", "Kalene", "Keaira", "Keelty", "Keely", "Keen", "Keitha", "Kellan", "Kennis", "Kerry", "Kevina", "Killian", "Kyna", "Lakyle", "Lee", "Mab", "Maeryn", "Maille", "Mairi", "Maisie", "Meara", "Meckenzie", "Myrna", "Nara", "Neala", "Nelia", "Oona", "Quinn", "Rhoswen", "Riane", "Riley", "Rogan", "Rona", "Ryan", "Sadb", "Shanley", "Shelagh", "Sine", "Siobhan", "Sorcha", "Ultreia", "Vevila"
    };
...
vector<string> FemaleName::hungarianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Bela", "Kamella", "Katalin", "Katoka", "Klara", "Klarika", "Lenci", "Lilike", "Lorand", "Nusa", "Onella", "Zigana", "Zizi", "Zsa Zsa"
    };
...
vector<string> FemaleName::indianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Ketaki", "Kusum", "Narmada", "Naveena", "Nishtha", "Nivedita", "Sahana", "Salena", "Sanchali", "Sanchaya", "Sanjana", "Shivani", "Shubhada", "Sumitra", "Swati", "Tarangini", "Tarjani", "Trilochana", "Zaqaria"
    };
...
vector<string> FemaleName::koreanGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Cho", "Chon", "HeeWon", "Jeong", "Joo Mi", "Min", "Moon", "Shin", "Soo", "Sun"
    };
...
vector<string> FemaleName::middleEnglishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Amiable", "Cavanaugh", "Citrine", "Doe", "Knowledge", "Lane", "Mercy", "Merry", "Scarlet"
    };
...
vector<string> FemaleName::norseGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Bo", "Frigg", "Grid", "Gro", "Guro", "Haley", "Heidrun", "Hela", "Magna", "Oda", "Ove", "Ragnhild", "Unni"
    };
...
vector<string> FemaleName::oldFrenchGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Chance", "Chantal", "Delight", "Fay", "Frances", "Jewel", "Musetta", "Olive", "Raissa", "Sojourner"
    };
...
vector<string> FemaleName::oldGermanGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Aloysia", "Carla", "Carol", "Chay", "Ella", "Emiline", "Ernestine", "Etta", "Ida", "Leopolda", "Leyna", "Lorraine", "Louise", "Minna"
    };
...
vector<string> FemaleName::oldNorseGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Astrid", "Deila", "Gail", "Harper", "Kippi", "Nessa", "Olive", "Ronalda", "Sigrid", "Thora", "Valda"
    };
...
vector<string> FemaleName::persianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Abtin", "Ardeshir", "Azarin", "Azura", "Cyra", "Darice", "Esther", "Fila", "Gelsey", "Jaleh", "Jasmine", "Kasra", "Kira", "Mahdis", "Mahsa", "Mandana", "Midge", "Mina", "Nickan", "Roxanne", "Sanam", "Vashti", "Yasmine", "Zeeba", "Zohreh"
    };
...
vector<string> FemaleName::polishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Danuta", "Ewa", "Filipina", "Jadwiga", "Kalene", "Karolina", "Kasia", "Kassia", "Klementyna", "Ksena", "Lilka", "Macy", "Olesia", "Rasine", "Tajsa", "Tekli", "Tesia", "Tola", "Tolia", "Truda", "Valeska", "Walentya", "Wislawa", "Zima", "Zofia", "Zotia"
    };
...
vector<string> FemaleName::polynesianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Kaula", "Lana", "Mahal", "Maili", "Pua", "Uinise", "Vailea"
    };
...
vector<string> FemaleName::sanskritGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Chandra", "Kalinda", "Kalpana", "Kama", "Karma", "Kashmir", "Leelea", "Lilac", "Malika", "Manjusha", "Nalini", "Opal", "Shobha", "Sitara", "Taruna"
    };
...
vector<string> FemaleName::scandinavianGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Alleta", "Bo", "Dagna", "Dahlia", "Delling", "Eir", "Erica", "Evonne", "Freya", "Gudrun", "Gunda", "Halle", "Idonea", "Ingrid", "Jesen", "Karena", "Kelda", "Kelsey", "Kiersten", "Krystyn", "Lang", "Larsen", "Linnea", "Lis", "Lisolette", "Litzy", "Loki", "Lundy", "Malin", "Marny", "Mia", "Nissa", "Quenby", "Quinby", "Ran", "Ranveig", "Rinda", "Runa", "Sanna", "Savea", "Selma", "Signa", "Signild", "Sigrun", "Snøfrid", "Sonja", "Sorley", "Svea", "Synnove", "Thorborg", "Thurid", "Thyrrni", "Toril", "Toyah", "Tyra", "Ula", "Unn", "Valkyrie", "Vanja", "Vigdis", "Viola", "Ylwa", "Zainab"
    };
...
vector<string> FemaleName::scottishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Ailsa", "Ainsley", "Artis", "Bonnie", "Campbell", "Davine", "Dree", "Enya", "Genene", "Ilisa", "Jeanne", "Kelcie", "Kelsi", "Lesley", "Leslie", "Logan", "Mairead", "Malvina", "Nairne", "Rae", "Sile", "Siusan", "Tira", "Vanora"
    };
...
vector<string> FemaleName::slavicGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Anezka", "Casmir", "Darva", "Kami", "Kamila", "Kamilia", "Karayan", "Katerina", "Katia", "Kisha", "Klavdia", "Kostya", "Lada", "Laima", "Lala", "Larya", "Lenka", "Lilia", "Lizina", "Lonna", "Malika", "Milena", "Nadine", "Natala", "Neda", "Neveah", "Nijole", "Ondrea", "Radinka", "Saskia", "Sveta", "Szitakota", "Tana", "Tania", "Tasya", "Teca", "Velika", "Vera", "Viera", "Yarmilla", "Zabel", "Zeljka", "Zora", "Zuzana"
    };
...
vector<string> FemaleName::swahiliGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Adia", "Barika", "Epua", "Kamaria", "Kesi", "Lakeisha", "Leta", "Nia", "Shani", "Simba", "Taariq", "Winda"
    };
...
vector<string> FemaleName::swedishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Kajsa", "Maj", "Signe", "Trind", "Valborg"
    };
...
vector<string> FemaleName::teutonicGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Magan", "Minka", "Orinda", "Verena", "Waltraud", "Willa", "Yvette"
    };
...
vector<string> FemaleName::turkishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Aylin", "Banu", "Jale", "Kari", "Karli", "Kerzi", "Kiral", "Nagihan", "Nerhim", "Nilgun", "Nuray", "Nurhan", "Olcay", "Onur", "Safak", "Sefika", "Semra", "Sezen", "Sibel", "Sila", "Zerdali"
    };
...
vector<string> FemaleName::vietnameseGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Cara", "Duyen", "Hong", "Khanh", "Kieu", "Lan", "Lieu", "Linh", "Loan", "Ly", "Mai", "Mychau", "Nguyet", "Nhi", "Nhu", "Nhung", "Nu", "Sen", "Tai", "Tam", "Tan", "Thao", "Thuy", "Tien", "Trang", "Trinh", "Tuyen", "Ut", "Xuan"
    };
...
vector<string> FemaleName::yiddishGivenNamesFemale(int count) const
{
    vector<string> randomNames;

    vector<string> names = { "Bruna", "Kyla", "Leba", "Mindel", "Shayndel", "Syshe"
    };
...
vector<string> FemaleName::getFirstName(int select, int count) const
{
    vector<string> firstName;

    if (select == 1)
    {
        firstName = africanGivenNamesFemale(count);
    }
    else if (select == 2)
    {
        firstName = africanAmericanGivenNamesFemale(count);
    }
    else if (select == 3)
    {
        firstName = americanGivenNamesFemale(count);
    }
    else if (select == 4)
    {
        firstName = arabicGivenNamesFemale(count);
    }
    else if (select == 5)
    {
        firstName = armenianGivenNamesFemale(count);
    }
    else if (select == 6)
    {
        firstName = celticGivenNamesFemale(count);
    }
    else if (select == 7)
    {
        firstName = chineseGivenNamesFemale(count);
    }
    else if (select == 8)
    {
        firstName = czechGivenNamesFemale(count);
    }
    else if (select == 9)
    {
        firstName = danishGivenNamesFemale(count);
    }
    else if (select == 10)
    {
        firstName = dutchGivenNamesFemale(count);
    }
    else if (select == 11)
    {
        firstName = egyptianGivenNamesFemale(count);
    }
    else if (select == 12)
    {
        firstName = englishGivenNamesFemale(count);
    }
    else if (select == 13)
    {
        firstName = finnishGivenNamesFemale(count);
    }
    else if (select == 14)
    {
        firstName = frenchGivenNamesFemale(count);
    }
    else if (select == 15)
    {
        firstName = gaelicGivenNamesFemale(count);
    }
    else if (select == 16)
    {
        firstName = germanGivenNamesFemale(count);
    }
    else if (select == 17)
    {
        firstName = greekGivenNamesFemale(count);
    }
    else if (select == 18)
    {
        firstName = hawaiianGivenNamesFemale(count);
    }
    else if (select == 19)
    {
        firstName = hebrewGivenNamesFemale(count);
    }
    else if (select == 20)
    {
        firstName = hindiGivenNamesFemale(count);
    }
    else if (select == 21)
    {
        firstName = hungarianGivenNamesFemale(count);
    }
    else if (select == 22)
    {
        firstName = indianGivenNamesFemale(count);
    }
    else if (select == 23)
    {
        firstName = irishGivenNamesFemale(count);
    }
    else if (select == 24)
    {
        firstName = italianGivenNamesFemale(count);
    }
    else if (select == 25)
    {
        firstName = japaneseGivenNamesFemale(count);
    }
    else if (select == 26)
    {
        firstName = koreanGivenNamesFemale(count);
    }
    else if (select == 27)
    {
        firstName = latinGivenNamesFemale(count);
    }
    else if (select == 28)
    {
        firstName = middleEnglishGivenNamesFemale(count);
    }
    else if (select == 29)
    {
        firstName = nativeAmericanGivenNamesFemale(count);
    }
    else if (select == 30)
    {
        firstName = norseGivenNamesFemale(count);
    }
    else if (select == 31)
    {
        firstName = oldEnglishGivenNamesFemale(count);
    }
    else if (select == 32)
    {
        firstName = oldFrenchGivenNamesFemale(count);
    }
    else if (select == 33)
    {
        firstName = oldGermanGivenNamesFemale(count);
    }
    else if (select == 34)
    {
        firstName = oldNorseGivenNamesFemale(count);
    }
    else if (select == 35)
    {
        firstName = persianGivenNamesFemale(count);
    }
    else if (select == 36)
    {
        firstName = polishGivenNamesFemale(count);
    }
    else if (select == 37)
    {
        firstName = polynesianGivenNamesFemale(count);
    }
    else if (select == 38)
    {
        firstName = russianGivenNamesFemale(count);
    }
    else if (select == 39)
    {
        firstName = sanskritGivenNamesFemale(count);
    }
    else if (select == 40)
    {
        firstName = scandinavianGivenNamesFemale(count);
    }
    else if (select == 41)
    {
        firstName = scottishGivenNamesFemale(count);
    }
    else if (select == 42)
    {
        firstName = slavicGivenNamesFemale(count);
    }
    else if (select == 43)
    {
        firstName = spanishGivenNamesFemale(count);
    }
    else if (select == 44)
    {
        firstName = swahiliGivenNamesFemale(count);
    }
    else if (select == 45)
    {
        firstName = swedishGivenNamesFemale(count);
    }
    else if (select == 46)
    {
        firstName = teutonicGivenNamesFemale(count);
    }
    else if (select == 47)
    {
        firstName = turkishGivenNamesFemale(count);
    }
    else if (select == 48)
    {
        firstName = vietnameseGivenNamesFemale(count);
    }
    else if (select == 49)
    {
        firstName = welshGivenNamesFemale(count);
    }
    else if (select == 50)
    {
        firstName = yiddishGivenNamesFemale(count);
    }
